        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-4">
            ...
            <div className="section-container relative z-10 w-full grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 tracking-tight min-h-[100px] md:min-h-[auto]">
                        Architecting <br />
                        <motion.span
                            key={textIndex}
                ...
                >
                    ...
                    <div className="relative z-10 w-full max-w-[350px] mx-auto group perspective-1000">
