...
const Hero = () => {
    ...
    return (
        <section id="hero" className="min-h-[100vh] flex flex-col justify-center relative overflow-hidden pb-20 mt-16 md:mt-24 lg:mt-32" style={{ paddingTop: '12vh' }}>
            {/* Background Glows */}
            ...
            <div className="layout-wrapper relative z-10 lg:grid lg:grid-cols-2 gap-12 items-center w-full">
                ...
                >
                    {/* Spacer removed - using grid margin/padding instead for more consistent alignment */}
