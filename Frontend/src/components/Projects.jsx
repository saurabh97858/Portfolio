...
const Projects = () => {
    ...
    return (
        <section id="projects" className="min-h-screen bg-slate-950 py-32 flex items-center justify-center relative overflow-hidden font-sans">
...
const ProjectCard = ({ project, variants, onClick, index }) => {
    ...
    return (
        ...
        >
            ...
            <motion.div className="relative flex-1 bg-slate-900/60 border border-white/10 p-8 md:p-10 rounded-[2.2rem] backdrop-blur-2xl transition-all duration-300 group-hover:bg-slate-900/90 shadow-2xl flex flex-col overflow-hidden">
