...
import { Heart, Navigation, Home } from 'lucide-react';
    ...
    return (
        <footer className="group relative z-50 bg-black mt-12 transition-all duration-500">
            ...
            <div className="w-full pt-16 pb-10">
                <div className="layout-wrapper max-w-6xl mx-auto px-4">
                    <div className="h-px bg-gradient-to-r from-transparent via-violet-500/40 to-transparent"></div>
                </div>
            </div>

            {/* Address Section */}
            <div className="layout-wrapper max-w-6xl mx-auto px-4 pb-8 md:pb-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    {/* Current Address */}
                    <div className="group relative p-4 sm:p-5 rounded-xl bg-white/[0.03] border border-white/5 hover:border-cyan-500/30 transition-all duration-300">
                        ...
                        <div className="relative flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs md:text-sm font-semibold text-slate-200 leading-relaxed">
                                    {portfolioData?.currentAddress || 'SAS Nagar (Mohali) , Punjab, India'}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Permanent Address */}
                    <div className="group relative p-4 sm:p-5 rounded-xl bg-white/[0.03] border border-white/5 hover:border-violet-500/30 transition-all duration-300">
                        ...
                        <div className="relative flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs md:text-sm font-semibold text-slate-200 leading-relaxed">
                                    {portfolioData?.permanentAddress || 'Kanpur Nagar, UttarPradesh, India'}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {/* Bottom Bar */}
            <div className="layout-wrapper max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
